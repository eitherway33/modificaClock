...
public class ClockSeg extends Application {
  ...
  public void start(final Stage stage) throws Exception {
    ...
    scene.getStylesheets().add(getResource("clock_seg.css"));
  ...
  static String getResource(String path) {
    return ClockSeg.class.getResource(path).toExternalForm();
  }
